...
const AllTask = () => {
  ...
  return (
    <div className="bg-[#1c1c1c] p-5 mt-5 rounded">
      <div className="bg-orange-600 mb-2 py-2 px-4 flex justify-between rounded">
      ...
      {authData.employeesData.map((elem, index) => {
        return (
          <div key={index} className="bg-zinc-800  mb-2 py-2 px-4 flex justify-between rounded">
